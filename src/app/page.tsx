    ...
    <div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 pt-20 pb-24 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-xl leading-relaxed" style={{ color: 'var(--muted)' }}>
              Northern Virginia&apos;s HOV-3 carpool network. Find a driver or rider at your nearest slug line spot in seconds &mdash; free, trusted, and decades-proven.
            </p>
      ...
      <section className="py-28 max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="mt-5 max-w-xl mx-auto text-lg" style={{ color: 'var(--muted)' }}>A time-honored commuter tradition where strangers share rides to use HOV-3 lanes &mdash; saving up to 45 minutes each way.</p>
        </div>
