...
export const metadata = {
  ...
  description: 'Search Sluglines pickup and return spots by corridor, county, direction, and destination.',
}

export default function SlugPickupPage() {
  return (
      ...
      <section className="border-b border-stone-200 bg-[#FAFAF8]">
        <div className="mx-auto max-w-6xl px-4 py-10">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">
            ...
            morning or afternoon direction, county or city, and known destination.
          </p>
        </div>
      </section>
