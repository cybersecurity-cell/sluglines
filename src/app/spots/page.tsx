...
const AFTERNOON_395_FAIRFAX = [{ name: 'Mark Center', lat: 38.8310454, lng: -77.1176246, active: true },{ name: 'Tysons Corner', lat: 38.931906, lng: -77.230132, active: true }]
const AFTERNOON_395_ARLINGTON = [{ name: 'Crystal City 12th St', lat: 38.8620732, lng: -77.048738, active: true },{ name: 'Crystal City 23rd St', lat: 38.85238, lng: -77.04964, active: true },{ name: 'Rosslyn', lat: 38.898092, lng: -77.071726, active: true },{ name: 'The Pentagon', lat: 38.8680768, lng: -77.0524506, active: true }]
const AFTERNOON_395_DC = [{ name: '14th St and Constitution Ave', lat: 38.889938, lng: -77.032021, active: true },{ name: '14th St and G St', lat: 38.8981415, lng: -77.0320751, active: true },{ name: '14th St and Independence', lat: 38.88733, lng: -77.032156, active: true },{ name: '14th St at Commerce Dept.', lat: 38.89462, lng: -77.03207, active: true },{ name: '15th St and New York Ave', lat: 38.8990078, lng: -77.033381, active: true },{ name: '19th St and F St', lat: 38.896695, lng: -77.043543, active: true },{ name: '19th St and I St', lat: 38.900711, lng: -77.043549, active: true },{ name: "L'Enfant Plaza", lat: 38.88489, lng: -77.023402, active: true },{ name: 'Navy Yard', lat: 38.8765811, lng: -77.0014703, active: true }]
const MORNING_66_FAIRFAX = [{ name: 'Fairfax Govt', lat: 38.8542902, lng: -77.3604273, active: true },{ name: 'Herndon-Monroe PnR', lat: 38.9513106, lng: -77.3823065, active: true },{ name: 'Stringfellow PnR', lat: 38.854028, lng: -77.404472, active: true },{ name: 'Vienna Metro South KnR', lat: 38.8774069, lng: -77.2706202, active: true }]
const MORNING_66_PRINCE_WILLIAM = [{ name: 'Cushing Road', lat: 38.7950597, lng: -77.563859, active: true }]
const MORNING_66_LOUDOUN = [{ name: 'East Gate', lat: 38.9119294, lng: -77.4914467, active: true },{ name: 'Stone Ridge', lat: 38.938222, lng: -77.555917, active: true }]
const AFTERNOON_66_ARLINGTON = [{ name: 'Rosslyn', lat: 38.896361, lng: -77.069444, active: true },{ name: 'The Pentagon', lat: 38.866806, lng: -77.056056, active: true }]
const AFTERNOON_66_DC = [{ name: '15th St and New York Ave', lat: 38.899133, lng: -77.033086, active: true },{ name: '19th St and F St', lat: 38.8970281, lng: -77.0435598, active: true },{ name: 'Foggy Bottom', lat: 38.90075, lng: -77.049611, active: true },{ name: "L'Enfant Plaza", lat: 38.8849257, lng: -77.0211657, active: true },{ name: 'Navy Yard', lat: 38.8766068, lng: -77.0009934, active: true }]
...
function SpotGroup({ county, spots }: { county: string; spots: Spot[] }) {
  return (
    <div className="rounded-xl border overflow-hidden" style={{ borderColor: 'var(--border)', background: 'var(--surface)' }}>
      ...
      <ul className="px-4">{spots.map(s => <SpotItem key={s.name} name={s.name} lat={s.lat} lng={s.lng} active={s.active} />)}</ul>
    </div>
  )
}
