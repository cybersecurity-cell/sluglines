...
export const DEFERRED_M3_ENDPOINTS: readonly DeferredEndpoint[] = [
  ...
  {
    route: '/api/offers/waitlist',
    operation: 'join the waitlist for a full offer; auto-renotify with a 10-minute soft hold',
    missing: ['offer_waitlist', 'offer_waitlist_join'],
    blockedOn: 'rev. 5.3 §11 Phase 4 — waitlist auto-renotify',
  },
  {
