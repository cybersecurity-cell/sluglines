-- Curated Phase 1 production reference data.
-- Operational claims deliberately remain review-needed or historical until a
-- steward verifies them against a current primary source.
...
-- Remove two legacy rows that represented a destination as its own route.
